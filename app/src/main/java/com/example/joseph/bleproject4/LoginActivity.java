...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin()
    {
        ...
        String phoneNumb = mPhoneView.getText().toString();

        boolean cancel = false;
        View focusView = null;

        // Check for a valid phoneNumb, if the user entered one.
        if (!TextUtils.isEmpty(phoneNumb) && !isPhoneNumberValid(phoneNumb))
        {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, phoneNumb);
